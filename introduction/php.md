...
## ❓ Where we can find php to use?
**[Download php by clikcing here](https://www.php.net/downloads.php)**, or using a installation command on **CLI**
```shell
windows:
- winget install php
...
``There are two main areas where PHP scripts are used.``<br>
